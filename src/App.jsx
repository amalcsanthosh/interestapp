...
function App() {
  ...
  const handleCalulate = (e)=>{
    e.preventDefault()
    console.log("inside handleCalulate");
  ...
  return (
    <div style={{width:'100%', minHeight:'100vh'}} className='d-flex justify-content-center align-items-center bg-dark'>
     ...
     { invalidPrinciple && <div className="mb-3 text-danger fw-bolder">
      ...
      <Button type='submit' onClick={handleCalulate} disabled={invalidPrinciple ||invalidRate || invalidYear } variant="contained" style={{width:'50%',height:'70px'}} className='bg-dark '>Calculate</Button>
